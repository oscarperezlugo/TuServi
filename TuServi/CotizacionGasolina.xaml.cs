...
namespace TuServi
{
    ...
    public partial class CotizacionGasolina : ContentPage
    {
        IUserDialogs Dialogs = UserDialogs.Instance;

        public CotizacionGasolina()
        {
            InitializeComponent();
            //KilometrajeUlt.Placeholder = Application.Current.Properties["km_ultimo_servicio"].ToString();
        ...
        private async void Solicitar_Clicked(object sender, EventArgs e)
        {
            ...
            servicio.id_servicio = 3;
            servicio.descripcion = "Filtro de gasolina";
